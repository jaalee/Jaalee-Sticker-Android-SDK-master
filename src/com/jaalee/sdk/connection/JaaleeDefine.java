...
public class JaaleeDefine
{
	...
	public static final int STICKER_AUDIO_STATE_ENABLE = 0;
	public static final int STICKER_AUDIO_STATE_ENABLE_WHEN_START = 1;
	public static final int STICKER_AUDIO_STATE_ENABLE_WHEN_TAP = 2;
	public static final int STICKER_AUDIO_STATE_DISABLE = 3;
	...
	public static final int JAALEE_ENABLE_RING_WHEN_DISCONNECT = 1;
	public static final int JAALEE_DISABLE_RING_WHEN_DISCONNECT = 0;
}
