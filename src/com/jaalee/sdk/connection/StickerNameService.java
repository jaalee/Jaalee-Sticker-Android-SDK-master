 ...
 */
 public class StickerNameService implements BluetoothService
 {
	 ...
	 public void processGattServices(List<BluetoothGattService> services)
	 {
		 for (BluetoothGattService service : services)
			 if (JaaleeUuid.STICKER_NAME.equals(service.getUuid())) {
					if (service.getCharacteristic(JaaleeUuid.STICKER_NAME_CHAR) != null)
					{
						this.characteristics.put(JaaleeUuid.STICKER_NAME_CHAR, service.getCharacteristic(JaaleeUuid.STICKER_NAME_CHAR));	
					}
					
					if (service.getCharacteristic(JaaleeUuid.STICKER_NEW_NAME_CHAR) != null)
					{
						this.characteristics.put(JaaleeUuid.STICKER_NEW_NAME_CHAR, service.getCharacteristic(JaaleeUuid.STICKER_NEW_NAME_CHAR));	
					}
	...
	public void onCharacteristicWrite(BluetoothGattCharacteristic characteristic, int status) {
	 ...
	 public String getStickerName()
	 {
		 if (mCurrentIsJaaleeNewBeacon)
		 {
			 return this.characteristics.containsKey(JaaleeUuid.STICKER_NEW_NAME_CHAR) ?
					 getStringValue(((BluetoothGattCharacteristic)this.characteristics.get(JaaleeUuid.STICKER_NEW_NAME_CHAR)).getValue()) : null;
		 }
		 return this.characteristics.containsKey(JaaleeUuid.STICKER_NAME_CHAR) ?
				 getStringValue(((BluetoothGattCharacteristic)this.characteristics.get(JaaleeUuid.STICKER_NAME_CHAR)).getValue()) : null;		
	 }
