  ...
  implements BluetoothService
{
	...
	public void processGattServices(List<BluetoothGattService> services)
	{
		for (BluetoothGattService service : services)
			if (JaaleeUuid.STICKER_ALERT.equals(service.getUuid())) {
				
				if (service.getCharacteristic(JaaleeUuid.STICKER_ALERT_CHAR) != null)
				{
					this.characteristics.put(JaaleeUuid.STICKER_ALERT_CHAR, service.getCharacteristic(JaaleeUuid.STICKER_ALERT_CHAR));
				}
			}
	}
